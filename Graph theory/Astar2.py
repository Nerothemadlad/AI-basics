...
class Graph:
    ...
    def a_star_algorithm(self, start_node, stop_node):
        ...
        while len(open_list) > 0:
            ...
            if n == stop_node or (n in stop_node):
                reconst_path = []
                ...
                nodes_visited = open_list | closed_list

                print('')
                print('Path found: {}'.format(reconst_path))
                # print(f'Nodes visited: {nodes_visited}')
                # print(f'Number of nodes visited: {len(nodes_visited)}')
                return reconst_path
...
# graph1.ucs_algorithm('A', 'D')
# graph1.greedy_algorithm('A', 'D')
